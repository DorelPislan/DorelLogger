...
int TestWindowsDebugSink()
{
  ...
  log.LogMessageFmt(ISink::MessageType::Info, SRC_POS,
...
int TestStdFileSink()
{
  ...
  log.LogMessage(ISink::MessageType::Info, SRC_POS, L"Some info");
  log.LogMessage(ISink::MessageType::Error, SRC_POS, L"Some error");
