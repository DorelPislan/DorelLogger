#ifndef _DOREL_LOGGER_ATL_SPECIFIC_FORMATTERS_H_
#define _DOREL_LOGGER_ATL_SPECIFIC_FORMATTERS_H_

#ifdef ENABLE_ATL_CSTRING_FORMATTER
...
#endif  // _DOREL_LOGGER_ATL_SPECIFIC_FORMATTERS_H_
