...
#define LOG_INFO_FMT(aFormat, ...)                                                   \
  {                                                                                  \
    ...
    if (logger.ShouldLog(ISink::MessageType::Info))                                  \
    {                                                                                \
      logger.LogMessageFmt(ISink::MessageType::Info, SRC_POS, aFormat, __VA_ARGS__); \
    }                                                                                \
  }
...
#define LOG_INFO(msg)                                                                    \
  {                                                                                      \
    ...
    if (logger.ShouldLog(ISink::MessageType::Info))                                      \
    {                                                                                    \
      logger.LogMessage(ISink::MessageType::Info, SRC_POS,                               \
